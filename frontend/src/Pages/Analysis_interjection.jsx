...
const Interjectiongraph = styled.div`
    position: absolute;
    top: 50%;
    left: 8%;
    width: 400px;
...
`;
export default function Analysis_interjection(){
    ...
    const api = 'api/v1/result/1/interjection';
        ...
        <Form>
            ...
            <ViewFrame>
                <ViewFrame2>
                    ...
                    <Analysis_NavBar2/>
                    <Video>
                        <video ref={videoRef} height="350px" width="500px" src={interjectionInfo.url} controls/>
                    </Video>
                    <Scoregraph>추임새 점수 그래프</Scoregraph>
                    <Timestamp>
                        <DummyTable>
                            <ul>
                    ...
                    <Interjectiongraph>추임새 시각화</Interjectiongraph>
