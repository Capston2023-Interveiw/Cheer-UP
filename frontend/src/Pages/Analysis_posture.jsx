...
`;
export default function Analysis_posture(){
        ...
        <Form>
            ...
            <ViewFrame>
                <ViewFrame2>
                    ...
                    <Analysis_NavBar2/>
                    <Video>
                        <video ref={videoRef} height="350px" width="500px" src={postureInfo.url} controls/>
                    </Video>
                    <Scoregraph>자세 점수 그래프</Scoregraph>
                    <Timestamp>
                        <DummyTable>
                            <ul>
                            {postureInfo.logs !== undefined
                                ? postureInfo.logs.map((data, index) => {
                                    return(
                                        <div key={index}>
                    ...
                    <Feedback>
                        ...
                        <Text>
                            {postureInfo.feedback}
                        </Text>
                    </Feedback>
                    <Posturegraph>자세 시각화</Posturegraph>
