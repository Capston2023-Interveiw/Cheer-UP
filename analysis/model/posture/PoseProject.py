...
class Posture:
    ...
    def run_posture(self, frame):
        ...
        try:
            ...
            # Calculate angle
            angle = self.calculate_angle(left_shoulder, right_shoulder)

            # Extract Pose landmarks
            pose = self.results.pose_landmarks.landmark
            ...
            return body_language_class, angle<170
