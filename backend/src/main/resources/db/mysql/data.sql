...
INSERT INTO feedback (content, score, analysis_id) VALUES ('표정 변화가 상대적으로 유동적입니다. 힘이 없거나 어두운 표정보다는 자신감을 가지고 긍정적인 표정을 유지하며 면접에 응시하기 바랍니다. 답변을 하면서 입술이 살짝 올라가 있을 수 있도록 연습하는 것을 추천드립니다.', '15', '1');
INSERT INTO feedback (content, score, analysis_id) VALUES ('표정 변화로 지원자의 표정이 얼마나 의욕적인지로 평가하기도 합니다. 무표정하게 있거나 압박 질문에 당황해 자신도 모르는 표정 상태가 드러날 수 있습니다. 따라서 표정에 유의하여 카메라에 적응해 자연스러운 표정을 연습할 필요가 있습니다.', '10', '1');
INSERT INTO feedback (content, score, analysis_id) VALUES ('면접에 부정적인 표정이 많습니다. 급격하게 표정 변화가 많거나 경직되어 있는 모습은 면접관에게 호감도를 주기 힘듭니다. 대답을 하며 비슷하게 긍정적인 표정을 유지할 수 있도록 거울을 보고 말하는 연습을 하거나 스마트폰으로 자신이 말하면서 짓는 표정을 촬영해 가면서 준비할 것을 권합니다.', '0', '1');

INSERT INTO feedback (content, score, analysis_id) VALUES ('바른 자세로 인사 담당자에게 호감과 안정감을 줍니다. 지금 자세를 유지해 주세요.', '20', '2');
INSERT INTO feedback (content, score, analysis_id) VALUES ('자세에서 약간의 감점이 있었습니다. 너무 경직되어 있거나 불안정한 자세는 인사 담당자에게 부정적인 인상을 줄 수 있습니다. 고개를 살짝 당기고 가슴을 바르게 펴는 연습을 평소에 하는 것이 중요합니다.', '15', '2');
INSERT INTO feedback (content, score, analysis_id) VALUES ('자세에서 감점이 있었습니다. 자세는 호감도와 진정성을 평가할 수 있는 항목입니다. 답변을 하는 동안 상체의 움직임과 어깨 각도 등을 주의해 주세요. 평소에 일상생활에서도 바른 자세를 유지하는 연습을 하는것이 중요합니다.', '10', '2');
INSERT INTO feedback (content, score, analysis_id) VALUES ('자세에서 많은 감점이 있었습니다. 바르지 않은 자세는 면접에 임하는 마음에 대해 인사 담당자에게 부정적인 인상을 줄 수 있습니다. 상체의 움직임, 어깨의 각도, 경직된 움직임 등을 고려하여 거울을 보며 바른 자세 습관을 만들도록 노력해야 합니다.', '0', '2');
...
INSERT INTO feedback (content, score, analysis_id) VALUES ('빈번하게 시선을 다른 곳에 오랫동안 두는 것은 인사 담당자에게 산만한 태도와 자신감이 없는 태도로 인식되는 것으로 이어집니다. 면접에 대해 긴장이 되어 시선을 집중하기 어렵다면 실제 면접에서라면 면접관의, AI 면접이라면 자신의 인중이나 코, 미간 등을 바라보며 차분히 대답을 하는 것을 추천드립니다.', '0', '3');

INSERT INTO feedback (content, score, analysis_id) VALUES ('불필요한 추임새 없이 자신의 의견을 정확하고 끊김 없이 매끄럽게 전달합니다. 인사 담당자에게 자신감 있고 준비된 지원자로 인식될 수 있습니다.', '20', '4');
INSERT INTO feedback (content, score, analysis_id) VALUES ('조금의 감점이 있지만 자연스러운 말투로 인식됩니다. 답변 준비 시간 때 질문을 보며 머릿속으로 어떤 답변을 할 지 구상하며 말한다면 좋은 결과가 예상됩니다.', '15', '4');
INSERT INTO feedback (content, score, analysis_id) VALUES ('추임새를 자주 반복하며 문장들을 매끄럽게 말하지 못한다면 자신의 답변에 확신이 없어보일 수 있습니다. 미리 질문을 본 후 말을 생각하여 천천히 자신감 있게 답변한다면 자신의 의견을 정확하게 전달할 수 있습니다. 긴문장을 한번에 말을 하려고 하기 보다는 짧고 간결한 문장들로 구성해 답변을 하시기 바랍니다.', '10', '4');
INSERT INTO feedback (content, score, analysis_id) VALUES ('면접에서 불필요한 추임새는 준비되지 않은 지원자로 보일 수 있어 삼가하는 것이 좋습니다. 조금 천천히 답변하더라도 본인의 의견을 정확하고 매끄럽게 전달하는 것이 중요합니다. 불필요한 추임새가 반복된다면 조금 천천히 말하거나 짧은 문장들로 구성해 자신의 의견을 정확하고 매끄럽게 전달하는 연습을 하는 것을 추천드립니다.', '0', '4');
